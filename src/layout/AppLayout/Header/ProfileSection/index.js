...
import { redirectToRelativePage, deleteSession, getSession, API_HOST } from 'common/common';
                ...
                <MainCard border={false} elevation={16} content={false} boxShadow shadow={theme.shadows[16]}>
                  <Box sx={{ p: 2 }}>
                    ...
                    <OutlinedInput
                      ...
                      placeholder="Opciones de perfil de búsqueda"
                      startAdornment={
                          ...
                          <Grid container spacing={3} direction="column">
                            <Grid item>
                              <Grid item container alignItems="center" justifyContent="space-between">
                                <Grid item>
                                  <Typography variant="subtitle1">Iniciar el modo DND</Typography>
                                </Grid>
                                <Grid item>
                                  <Switch
                                    color="primary"
